...
export default function CombinedQRScanner({ students, onMarkAttendance, markedBy }: CombinedQRScannerProps) {
  ...
  const detectQRCodeFromImageData = (_imageData: ImageData): string | null => {
  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <Tabs value={activeMode} onValueChange={(value: string) => setActiveMode(value as 'camera' | 'manual')} className="space-y-6">
