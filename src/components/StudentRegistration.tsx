        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              />
              {errors.name && (
                <p className="text-red-600 text-sm bg-red-50 p-2 rounded border border-red-200">{errors.name}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {errors.schoolId && (
                <p className="text-red-600 text-sm bg-red-50 p-2 rounded border border-red-200">{errors.schoolId}</p>
              )}
            ...
            <div className="space-y-2">
              ...
              {errors.class && (
                <p className="text-red-600 text-sm bg-red-50 p-2 rounded border border-red-200">{errors.class}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {errors.email && (
                <p className="text-red-600 text-sm bg-red-50 p-2 rounded border border-red-200">{errors.email}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {errors.confirmEmail && (
                <p className="text-red-600 text-sm bg-red-50 p-2 rounded border border-red-200">{errors.confirmEmail}</p>
              )}
            </div>

            <Button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white border-0 h-11" disabled={isLoading}>
              {isLoading ? (
                <>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600">
              ...
              <Button variant="link" onClick={onShowLogin} className="p-0 h-auto text-blue-600 hover:text-blue-700">
                Sign in here
              </Button>
            </p>
          </div>
