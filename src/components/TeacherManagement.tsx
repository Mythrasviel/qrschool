...
export default function TeacherManagement({
  ...
  const handleAddTeacher = (e: React.FormEvent) => {
    ...
    toast.success(`Teacher ${formData.name} has been added successfully.`);
  };
  ...
  const handleEditTeacher = (e: React.FormEvent) => {
    ...
    toast.success(`Teacher ${formData.name} has been updated successfully.`);
  };
  ...
  const resetTeacherPassword = (teacher: Teacher) => {
    ...
    onUpdateTeacher(updatedTeacher);
    toast.success(`Password reset for ${teacher.name}. New password: teacher123`);
  };
  ...
  const handleDeleteTeacher = () => {
    if (teacherToDelete) {
      ...
      toast.success(`Teacher ${teacherToDelete.name} has been deleted.`);
            ...
            <DialogContent className="border-0 shadow-lg">
              <DialogHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <DialogTitle className="text-blue-900">Add New Teacher</DialogTitle>
                </div>
          ...
          <DialogContent className="border-0 shadow-lg">
            <DialogHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <DialogTitle className="text-green-900">Edit Teacher</DialogTitle>
              </div>
              <DialogDescription className="text-slate-600">
            ...
            <form onSubmit={handleEditTeacher} className="space-y-4">
              ...
              <div className="flex justify-end gap-3">
                <Button type="button" variant="outline" onClick={() => setIsEditDialogOpen(false)} className="border-slate-200 text-slate-700 hover:bg-slate-50">
                  Cancel
                </Button>
                <Button type="submit" className="bg-green-600 text-white hover:bg-green-700 shadow-sm">
          ...
          <AlertDialogContent className="border-0 shadow-lg">
            <AlertDialogHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <AlertDialogTitle className="text-red-900">Delete Teacher</AlertDialogTitle>
              </div>
              <AlertDialogDescription className="text-slate-600 leading-relaxed">
                Are you sure you want to delete <strong className="text-slate-900">{teacherToDelete?.name}</strong>? This action cannot be undone.
                <br /><br />
                All attendance records marked by this teacher will remain but will show the teacher as deleted.
